...
**Core Functionality:**
- ✅ Single workout mode: Work → Rest → Work → Rest for N rounds
- ✅ Dynamic rest calculation (work time × ratio)
- ✅ Configurable work:rest ratios (presets: 0.5, 1, 1.5, 2 + custom decimal input)
- ✅ Configurable number of rounds (2-100+)
- ✅ Manual tap/button to end work phase
- ✅ Automatic transition from rest to work
- ✅ Pause/resume functionality
- ✅ Stop workout with confirmation dialog

**Display:**
- ✅ Current round indicator
- ✅ Elapsed work time (during work phase)
- ✅ Rest countdown (during rest phase)
- ✅ Total elapsed time
- ✅ Large, gym-readable numbers
- ✅ Dark mode and light mode

**Audio:**
- ✅ Beep countdown during final seconds of rest (e.g., 3, 2, 1)
- ✅ Distinct beeps for final round
...
- ✅ State persistence (recover from app kill mid-workout)
...
**In Scope:**
- ✅ No sensitive data collection (no accounts, no personal info)
...
- ✅ Rest calculation is mathematically correct (work × ratio)
...
- ✅ Timer state machine (idle, work, rest, paused, complete)
- ✅ Work phase with elapsed time display
- ✅ Rest phase with countdown display
- ✅ Ratio configuration (presets + custom)
...
**Deliverables:**
- ✅ Audio beep system (3, 2, 1 countdown)
- ✅ Final round audio indicator
...
- ✅ Settings screen (theme, defaults)
- ✅ Improved UI (large numbers, gym-readable)
- ✅ Persist last-used settings
- ✅ Error handling and edge cases
- ✅ APK build and sideload testing
...
Group 1:
  ...
  → Group Rest (group ratio × total group time)
Group 2: (repeat)
```
